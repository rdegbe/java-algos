 ...
 * which outperforms Java's ArrayList by around factor of 10-15x!
...
public class DynIntegerArray implements Iterable<Integer> {
  ...
  public DynIntegerArray() {
    this(DEFAULT_CAP);
  }

  // Initialize the array with a certain capacity
  public DynIntegerArray(int capacity) {
  ...
  public DynIntegerArray(int[] array) {
  ...
  public static void main(String[] args) {
    ...
    DynIntegerArray ar = new DynIntegerArray(50);
    ar.add(3);
    ar.add(7);
    ar.add(6);
    ar.add(-2);
